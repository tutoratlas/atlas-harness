...
const createDesktopBridgeStub = (overrides?: {
  ...
  return {
    ...
    deleteStudentWorkspace: vi.fn().mockResolvedValue({ success: true }),
  };
};
...
describe("GeneralSettingsPanel observability", () => {
  ...
  it("shows a disabled network access toggle with guidance in desktop builds", async () => {
    ...
    await expect
      .element(page.getByText("TutorAtlas will restart to expose this environment over the network."))
      .toBeInTheDocument();
